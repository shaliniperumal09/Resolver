...
public class TestClass extends BaseClass {
	...
	public void test4()
	{
		...
		//List<WebElement>  l1=driver.findElements(By.xpath("//*[@id=\"test-3-div\"]/div/div/a"));
	...
	public void test6()
	{
...

		{
...

			{
				...
				String tbdata2=driver.findElement(By.xpath("//*[@id=\"test-6-div\"]/div/table//tr[2]//td[2]")).getText();

				System.out.print(tbdata2);
...

				{
					...
					String tbdata2=driver.findElement(By.xpath("//*[@id=\"test-6-div\"]/div/table//tr[3]//td[3]")).getText();

					System.out.print(tbdata2);

					//System.out.println(tbdata);

					Assert.assertEquals(tbdata2, "Ventosanzap");
